					...
					<View style={ styles.middlePart }>
						...
						{ mode ?
							<FlatList
								...
								data={props.info}
								renderItem={({item}) => <ProdEnc goBack={() => {setMode(true), props.onCancel()}} name={item.name_prod} price={item.price_prod} qnt={item.qnt_prod} idProd={item.id_prod} nav={props.nav} />}
