	...
	return(
		<View style={{ flex: 1 }}>
			<View style={{ marginTop: StatusBar.currentHeight || 25, width: '100%', height: 220, position: 'absolute' }}>
				<Image resizeMode='cover' style={{ width: '100%', height: '100%' }} source={{uri: img ? img : data.img }} />
			</View>
						...
						<View style={ DetailsStyle.middlePart }>
							{
								images ? (
									...
									<Text style={{ fontSize: 20, color: lightMode ? Theme.preto : Theme.branco }}>No images available</Text>
								)
							}
						</View>
						<View style={ DetailsStyle.bottomPart }>
							<View style={{ backgroundColor: lightMode ? '#f4f4f5' : '#3c4146', width: '100%', padding: 10, borderRadius: 15, elevation: 5 }}>
							...
							<View style={{ width: '100%', alignItems: 'center', marginTop: 70 }}>
								...
								<View style={{ width: '90%', marginTop: 20}} >
									<Text style={[ DetailsStyle.companyInfo, { color: lightMode ? Theme.preto : Theme.branco, textAlign: 'center', marginBottom: 15 } ]}>{data.comp_details}</Text>
