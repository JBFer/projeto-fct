...
export default ImageLayout = ({ route }) => {
    ...
    return(
        <View style={{ height: '100%', width: '100%', backgroundColor: myGlobals.lightMode ? Theme.branco : Theme.backDark }}>
            <TouchableOpacity onPress={() => console.log("go back") }><Text>Fechar</Text></TouchableOpacity>
                <View style={ { height: '100%', width: '100%', backgroundColor: myGlobals.lightMode ? Theme.branco : Theme.backDark } }>
                    <ImageViewer
                        ...
                        backgroundColor={ myGlobals.lightMode ? Theme.branco : Theme.backDark}
                        flipThreshold={40}
                        maxOverflow={800}
                        pageAnimateTime={200}
                   />
